...
export default function SubscribeSection() {
  ...
  const validate = () => {
    ...
    if (!form.name.trim() || form.name.trim().length < 2)
      e.name = "Tên phải ít nhất 2 ký tự";
  ...
  return (
    ...
    >
        ...
        >
          <div className="fade-left">
            ...
            >
              Sở hữu PawCam Pro
              <br />
              <span style={{ color: "var(--accent)" }}>trước ngày ra mắt</span>
            </h2>
            ...
            >
              Đăng ký nhận thông báo ưu đãi ra mắt. Khách đặt trước được giảm{" "}
              <strong style={{ color: "var(--accent)" }}>15%</strong> và miễn
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onBlur={(e) =>
                          ((e.target as HTMLInputElement).style.borderColor =
                            errors.phone ? "#ef4444" : "var(--border)")
                        }
                      />
                      {errors.phone && (
                        <p
      ...
      <style>{`
        ...
        @media (max-width: 768px) { .subscribe-grid { grid-template-columns: 1fr !important; gap: 40px !important; } }
      `}</style>
    </section>
  );
}
